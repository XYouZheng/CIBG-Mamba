...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='CIBG-Mamba')
    ...
    parser.add_argument('--embedtype', type=str, default='learned',
                        help='time features encoding, options:[timeF, fixed, learned]')
    ...
    parser.add_argument('--patch_size', type=int, default=48, help='patchsize length')
